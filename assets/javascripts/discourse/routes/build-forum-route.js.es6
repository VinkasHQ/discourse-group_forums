...
export default function(filter, extras) {
  ...
  return Discourse.Route.extend({
    ...
    beforeModel() {
      this.controllerFor('navigation-forum').set('filterMode', filter);
    },
    ...
    setupController(controller, model) {
      ...
      this.controllerFor('navigation-forum').set('group', group);
      this.controllerFor('navigation-forum').set('canCreateTopic', model.get('can_create_topic'));
    },
    ...
    renderTemplate() {
      this.render('navigation-forum', { outlet: 'navigation-bar' });
